...
ASTNode
newCDecl(char *name, int front, int num, ASTNode CIDC, ASTNode CDecl)
{
	ASTNode new;
	NEW0(new);
	new->kind = KCDecl;
...
ASTNode
newCIDC(char *name, int front, int num, ASTNode CIDC)
{
	ASTNode new;
	NEW0(new);
	new->kind = KCIDC;
...
ASTNode
newIntDecl(char *name, ASTNode BN, ASTNode CID, ASTNode IntDecl)
{
	ASTNode new;
	NEW0(new);
	new->kind = KIntDecl;
...
ASTNode
newCIDI(char *name, ASTNode BN, ASTNode CIDI)
{
	ASTNode new;
	NEW0(new);
	new->kind = KCIDI;
...
ASTNode
newVDecl(char *name, ASTNode CDecl, ASTNode IntDecl, ASTNode Stmt, ASTNode VDecl)
{
	ASTNode new;
	NEW0(new);
	new->kind = KVDecl;
